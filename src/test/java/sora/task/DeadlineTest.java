...
class DeadlineTest {
    ...
    public void toString_notDone_returnsCorrectFormat() {
        ...
        assertEquals("[D][ ] Do something (by: Feb 08 2025 2359)", deadline.toString());
    }
    ...
    public void toString_markedDone_returnsCorrectFormat() {
        ...
        deadline.markAsDone();
        assertEquals("[D][X] Do something (by: Feb 08 2025 2359)", deadline.toString());
    }
    ...
    public void toFormat_notDone_returnsCorrectFormat() {
        LocalDateTime by = LocalDateTime.of(2006, 2, 8, 23, 59);
        Deadline deadline = new Deadline("Submit assignment", by);
        assertEquals("D | 0 | Do something | Feb 08 2025 2359", deadline.toFormat());
    }
    ...
    public void toFormat_done_returnsCorrectFormat() {
        ...
        Deadline deadline = new Deadline("Submit assignment", by);
        deadline.markAsDone();
        assertEquals("D | 1 | Do something | Feb 08 2025 2359", deadline.toFormat());
    }
}
