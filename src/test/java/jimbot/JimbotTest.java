...
public class JimbotTest {
    ...
    void jimbot_deadlineEventMarkAndUnmark_uiSuccess() {
        String simulatedInput = "deadline finish ip /by 01/09/2025 1200\n " +
                "event meeting /from 27/08/2025 1130 /to 27/08/2025 1400\n " +
                "mark 2\n mark 0\n delete 2\n mark 1\n unmark 1\n bye\n";
        ByteArrayInputStream inContent = new ByteArrayInputStream(simulatedInput.getBytes());
        System.setIn(inContent);
        ...
        String expected = """
                         ...
                         (￣^￣)ゞ ╯
                             ┌───────────────────────────────────────────────────────────────────────┐
                             │ Got it. I've added this task:                                         │
                             │     [E][ ] meeting (FROM: Aug 27 2025, 11:30 TO: Aug 27 2025, 14:00)  │
                             │ Now you have 2 tasks in the list!                                     │
                             └───────────────────────────────────────────────────────────────────────┘
                         (￣^￣)ゞ ╯
                                    ┌───────────────────────────────────────────────────────────────────────┐
                                    │ Nice♪ I've marked this task as done:                                  │
                                    │     [E][X] meeting (FROM: Aug 27 2025, 11:30 TO: Aug 27 2025, 14:00)  │
                                    └───────────────────────────────────────────────────────────────────────┘
                        ♪ ｖ(＾＿＾ｖ)♪ ~~ ♪(ｖ＾＿＾)ｖ ╯
                               ┌──────────────────────────┐
