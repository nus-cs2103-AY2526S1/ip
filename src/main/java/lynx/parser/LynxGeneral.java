...
public abstract class LynxGeneral {
     ...
     */
    public static String reload() throws LynxException {
     ...
     */
    public static String save() throws LynxException {
        LynxFileManager.createFile();
     ...
     */
    public static String addTodo(String input) throws LynxException {
        if (input.length() <= 4) {
        ...
        return LynxTaskList.addTask(task);
    }
     ...
     */
    public static String addDeadline(String input) throws LynxException {
        if (input.length() <= 8) {
     ...
     * @throws LynxException If command, name or date is invalid.
     */
    public static String addEvent(String input) throws LynxException {
        if (input.length() <= 5) {
