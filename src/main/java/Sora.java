        ...
        while(true){
            try {
                ...
                if (input.equals("bye")) {
                    ...
                    task.get(x-1).markAsDone();
                    System.out.println("Nice! I've marked this task as done:");
                    System.out.println(task.get(x-1).toString());
                } else if (part.length == 2 && part[0].equals("unmark")) {
                    int x = Integer.parseInt(part[1]);
                    task.get(x-1).markAsNotDone();
                    ...
                    if (part[0].equals("todo")) {
                        ...
                        System.out.println(task.getLast().toString());
                        System.out.println("Now you have " + task.size() + " tasks in the list.");
                        ...
                        task.add(new Deadline(check[0], check[1]));
                        System.out.println("Got it. I've added this task:");
                        System.out.println(task.getLast().toString());
                        System.out.println("Now you have " + task.size() + " tasks in the list.");
                        ...
                        task.add(new Event(check[0], time[0], time[1]));
                        System.out.println("Got it. I've added this task:");
                        System.out.println(task.getLast().toString());
                        System.out.println("Now you have " + task.size() + " tasks in the list.");
                    }
