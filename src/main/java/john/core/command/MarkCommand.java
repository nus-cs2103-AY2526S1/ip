...
/**
 * Command that marks a task as completed by its 1-based position in the list.
 * <p>
 * Responsibilities:
 * - Validate the provided 1-based index against the current list size.
 * - Mark the referenced task as complete when valid.
 ...
 * <p>
 * Side effects:
 * - Mutates the given TaskList by marking one task complete (when valid).
...
public class MarkCommand implements Command {
    ...
    /**
     * Executes the command: marks the task at the given 1-based index as complete and saves the list.
     *
