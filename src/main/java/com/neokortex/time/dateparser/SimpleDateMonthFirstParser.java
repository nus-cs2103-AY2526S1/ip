...
/**
 * Represents a date parser that parses dates in the format: mm/dd/yyyy or mm/dd/yy
 * <p>
 * 'mm' represent numerical month, 'dd' representing day in the month, yyyy representing year,
 * each y representing digits
 * </p>
 */
